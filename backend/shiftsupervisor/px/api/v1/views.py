...
from px.api.v1.serializers import (
    U400Serializer,
    U700Serializer,
    U800Serializer,
    U950Serializer,
    U970Serializer,
    DailyDataPXSerializer,
)
...
class U400HelpTextViewSet(HelpTextViewSet):
    model = U400


class U700HelpTextViewSet(HelpTextViewSet):
    model = U700


class U800HelpTextViewSet(HelpTextViewSet):
    model = U800


class U950HelpTextViewSet(HelpTextViewSet):
    model = U950


class U970HelpTextViewSet(HelpTextViewSet):
    model = U970
